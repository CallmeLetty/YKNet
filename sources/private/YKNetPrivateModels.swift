...
struct YKNetTaskHandler {
    ...
    var progress: YKNetDownloadProgress
    var success: YKNetResponse?
    var requestFail: YKNetErrorCompletion
}
...
struct ArMultipartFormDataRequest {
    ...
    let url: URL
    let timeout: YKNetRequestTimeout
    let method: YKNetHTTPMethod

    init(method: YKNetHTTPMethod,
         url: URL,
         timeout: YKNetRequestTimeout) {
        self.url = url
